...
func (_Erc721 *Erc721Caller) FLEXABLENFTADMINROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "FLEXABLENFT_ADMIN_ROLE")
...
func (_Erc721 *Erc721Session) FLEXABLENFTADMINROLE() ([32]byte, error) {
	return _Erc721.Contract.FLEXABLENFTADMINROLE(&_Erc721.CallOpts)
}
...
func (_Erc721 *Erc721Caller) FLEXABLENFTCREATORROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "FLEXABLENFT_CREATOR_ROLE")
...
func (_Erc721 *Erc721Session) FLEXABLENFTCREATORROLE() ([32]byte, error) {
	return _Erc721.Contract.FLEXABLENFTCREATORROLE(&_Erc721.CallOpts)
}
...
func (_Erc721 *Erc721Caller) FLEXABLENFTOPERATORROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "FLEXABLENFT_OPERATOR_ROLE")
...
func (_Erc721 *Erc721Session) FLEXABLENFTOPERATORROLE() ([32]byte, error) {
	return _Erc721.Contract.FLEXABLENFTOPERATORROLE(&_Erc721.CallOpts)
}
...
func (_Erc721 *Erc721Caller) FlexableNFTNFTs(opts *bind.CallOpts, arg0 *big.Int) (string, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "FlexableNFTNFTs", arg0)
...
func (_Erc721 *Erc721Session) FlexableNFTNFTs(arg0 *big.Int) (string, error) {
	return _Erc721.Contract.FlexableNFTNFTs(&_Erc721.CallOpts, arg0)
}
...
func (_Erc721 *Erc721Transactor) CreateTicket(opts *bind.TransactOpts, metadataHash string) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "createTicket", metadataHash)
}
...
func (_Erc721 *Erc721Session) CreateTicket(metadataHash string) (*types.Transaction, error) {
	return _Erc721.Contract.CreateTicket(&_Erc721.TransactOpts, metadataHash)
}
...
func (_Erc721 *Erc721Transactor) DelegateTicketCreation(opts *bind.TransactOpts, creator common.Address, metadataHash string) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "delegateTicketCreation", creator, metadataHash)
}
...
func (_Erc721 *Erc721Session) DelegateTicketCreation(creator common.Address, metadataHash string) (*types.Transaction, error) {
	return _Erc721.Contract.DelegateTicketCreation(&_Erc721.TransactOpts, creator, metadataHash)
}
...
func (_Erc721 *Erc721Transactor) SetStatus(opts *bind.TransactOpts, tokenId *big.Int, status string) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "setStatus", tokenId, status)
}
...
func (_Erc721 *Erc721Session) SetStatus(tokenId *big.Int, status string) (*types.Transaction, error) {
	return _Erc721.Contract.SetStatus(&_Erc721.TransactOpts, tokenId, status)
}
...
func (it *Erc721StatusUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Erc721StatusUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (_Erc721 *Erc721Filterer) FilterStatusUpdated(opts *bind.FilterOpts) (*Erc721StatusUpdatedIterator, error) {
	...
	logs, sub, err := _Erc721.contract.FilterLogs(opts, "StatusUpdated")
	if err != nil {
		return nil, err
	}
	return &Erc721StatusUpdatedIterator{contract: _Erc721.contract, event: "StatusUpdated", logs: logs, sub: sub}, nil
}
...
func (_Erc721 *Erc721Filterer) WatchStatusUpdated(opts *bind.WatchOpts, sink chan<- *Erc721StatusUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _Erc721.contract.WatchLogs(opts, "StatusUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc721StatusUpdated)
				if err := _Erc721.contract.UnpackLog(event, "StatusUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
func (it *Erc721TicketCreatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Erc721TicketCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (_Erc721 *Erc721Filterer) FilterTicketCreated(opts *bind.FilterOpts, creator []common.Address) (*Erc721TicketCreatedIterator, error) {
	...
	logs, sub, err := _Erc721.contract.FilterLogs(opts, "TicketCreated", creatorRule)
	if err != nil {
		return nil, err
	}
	return &Erc721TicketCreatedIterator{contract: _Erc721.contract, event: "TicketCreated", logs: logs, sub: sub}, nil
}
...
func (_Erc721 *Erc721Filterer) WatchTicketCreated(opts *bind.WatchOpts, sink chan<- *Erc721TicketCreated, creator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc721.contract.WatchLogs(opts, "TicketCreated", creatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc721TicketCreated)
				if err := _Erc721.contract.UnpackLog(event, "TicketCreated", log); err != nil {
					return err
				}
				event.Raw = log
